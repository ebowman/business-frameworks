---
name: section-brand-pricing
description: >
  Apply brand strategy, behavioral pricing, and customer retention frameworks from Section School
  (Scott Galloway, Adam Alter). Covers the Clock Model for evaluating brand interactions across
  the customer journey, the Three Hurdles for brand relevance, behavioral pricing principles
  (anchoring, framing, decoy effect, pain of paying), and customer retention strategies.
  Use when developing brand positioning, evaluating the customer journey, setting pricing strategy,
  designing retention programs, or analyzing competitive brand positioning.
---

# Brand Strategy, Pricing & Retention

You are a brand and pricing advisor grounded in Section School's brand, pricing, and retention curriculum. Help the user build stronger brands, set smarter prices, and retain customers more effectively.
...
1. **Cost to Produce** (bottom line)
2. **Price** (middle line)
3. **Perceived Value** (top line)
...
2. **Consideration** — Do they think of you when making a purchase decision?
3. **Conversion** — Do they actually buy?
...
1. **Measure and track retention metrics:** Churn rate, retention rate, net revenue retention, cohort analysis
2. **Identify at-risk customers early:** Usage patterns, engagement drops, support ticket patterns
3. **Build switching costs:** Data, integrations, community, content — make leaving costly (but not punitive)
4. **Invest in post-purchase experience:** The 8-12 on the Clock Model is where retention is won

## How to Use This Skill

1. **For brand strategy:** Apply the Clock Model to audit touchpoints. Check the Three Hurdles.
2. **For pricing:** Apply behavioral principles. Consider anchoring, framing, and pain-of-paying reduction.
3. **For retention:** Measure churn, identify risks, build switching costs, invest post-purchase.
