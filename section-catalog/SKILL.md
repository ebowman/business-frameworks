...
description: >
  Discover and navigate all Section School business skills. Lists every available domain with
  key frameworks, instructors, and usage guidance. Use when exploring what Section School
  knowledge is available, choosing which skill to apply to a business challenge, or getting
  an overview of all business frameworks across strategy, product, problem-solving, finance,
  communication, leadership, data, negotiation, innovation, brand/pricing, and operations.
---

# Section School Skills Catalog

This catalog lists all available Section School business skills. Each skill is a deep knowledge base synthesized from Section School courses — covering frameworks, case studies, and practical tools taught by world-class instructors.
...
1. **Start with the challenge.** What type of problem are you facing?
2. **Match to a domain.** Each skill addresses a distinct business capability.
3. **Cross-reference when needed.** Many real challenges span domains — use multiple skills together. For example:
   - Building a new product? Combine **section-product** (strategy) + **section-finance** (business case) + **section-communication** (pitch)
   - Entering a new market? Combine **section-strategy** (T-Algorithm) + **section-innovation** (Growth Opportunity Framework) + **section-brand-pricing** (positioning)
   - Leading a team through change? Combine **section-leadership** (change management) + **section-communication** (storytelling) + **section-problem-solving** (structured thinking)
