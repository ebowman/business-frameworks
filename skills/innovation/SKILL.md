...
name: innovation
description: >
  Apply innovation frameworks from executive education courses (Sara Beckman, UC Berkeley Haas). Covers the
  Innovation Cycle (Understand, Reframe, Design, Test), Jobs-to-Be-Done theory, the RIME Framework
  for prioritizing innovation initiatives, the Growth Opportunity Framework, Web of Abstraction,
  Journey Audit, and Competency Audit. Use when developing new products or experiences, reframing
  customer problems, discovering hidden growth opportunities, prioritizing innovation bets, or
  de-risking new concepts through testing.
---
...
1. **Core** — Optimize existing experiences for existing customers (lowest risk)
2. **Adjacent** — Extend to new markets or new experiences (medium risk)
3. **Transformational** — New experiences for new markets (highest risk, highest potential)
...
1. **For opportunity discovery:** Start with the Innovation Cycle (Understand → Reframe). Use JTBD to uncover the real job.
2. **For portfolio planning:** Apply the Growth Opportunity Framework to classify and balance bets.
3. **For prioritization:** Use RIME to rank initiatives.
4. **For testing:** Design experiments that can falsify your hypothesis before committing resources.
